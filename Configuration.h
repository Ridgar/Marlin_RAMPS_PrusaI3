...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, (200.0*8/0.8)*1, 1178}  // default steps per unit for ultimaker
...
//Vecchi parametri per Ultimaker ma non adatti alla nostra prusa I3
/*#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E
...
//altro punto di ultima modifica del firmware
